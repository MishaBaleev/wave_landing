...
import demo_school from "../../PC/Sevices/img/demo_school.png";

const Services = () => {
    return <section className="mob_section services_mob">
        <div className="title_mob"><p>Услуги</p></div>
        <div className="block_mob">
            <div className="left_sec">
                <p>
                    Школа для детей с 7 по 11 класс и студентов колледжа. 
                    В школе мы будем изучать БПЛА, как их проектировать, собирать и управлять. 
